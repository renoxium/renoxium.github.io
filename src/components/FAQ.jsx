...
const faqs = [
  ...
  { q: 'How do you use modern tooling in the work?',           a: 'Sparingly and pragmatically. Senior engineers own architecture, judgment calls, and review. Modern tooling helps with the supporting work: scaffolding, migrations, test fixtures, documentation. The output is the same shape as a traditional studio\'s work, with throughput that is roughly 2 to 3 times faster.' },
