// Craft - replaces the services marquee. Awwwards-style interactive list:
// Each row is a service. On hover, the row's "preview plate" expands and the row
// title slides into italic. Cursor follows with a circular preview window
// containing an animated SVG "scene" describing what we do.
const craftStyles = {
  section: {
    position: 'relative',
...
function CraftScene({ name }) {
  // Each scene is a small animated SVG illustration that plays while hovered.
