// Process — film-strip with hover-flip number plate + scramble title
const processStyles = {
    ...
    <section id="process" data-screen-label="Process" style={processStyles.section}>
      <div className="wrap">
        <div className="proc-head reveal in" style={processStyles.head}>
          ...
          <p style={processStyles.blurb}>Twenty years of software development has taught us one thing: clarity beats velocity. Every project follows the same rhythm, a tight loop you can predict, measure, and trust.
