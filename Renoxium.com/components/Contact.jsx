// Contact — split panel: left form, right meta with Dubai address & live time
...
const contactStyles = {
  ...
  head: {
    textAlign: 'center', maxWidth: 760, margin: '0 auto 72px'
  },
...
function Contact() {
  const [services, setServices] = React.useState(new Set(['SaaS']));
  const [budget, setBudget] = React.useState('$50k–$150k');
  const [submitted, setSubmitted] = React.useState(false);
  const [time, setTime] = React.useState(() => fmtDubaiFull());
    ...
    <section id="contact" data-screen-label="Contact" style={contactStyles.section}>
      <div className="wrap">
        <div style={contactStyles.head}>
          ...
          <p style={contactStyles.blurb}>Tell us a little about the project. We reply within 2 business (tops) during Dubai business days. Usually with a calendar link and a question or two.
        ...
        <div className="contact-card" style={contactStyles.card}>
          ...
          <aside style={contactStyles.side}>
            <div style={{ ...contactStyles.block, gap: 14 }}>
              ...
              <div style={{ ...contactStyles.blockValue, color: 'var(--ink-3)', fontSize: 14 }}>
                {'\n'}
              </div>
            </div>
            ...
            <div style={contactStyles.block}>
              <div style={contactStyles.blockLabel}>
</div>
              <a style={contactStyles.link} href="tel:+97144000000">
</a>
            </div>
            <div style={contactStyles.block}>
              <div style={contactStyles.blockLabel}>
</div>
              <div style={contactStyles.blockValue}>
</div>
            </div>
          </aside>
        </div>
