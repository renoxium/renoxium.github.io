...
const styles: Record<string, CSSProperties> = {
  ...
  stepBody: { color: 'var(--ink-3)', fontSize: 14, lineHeight: 1.6 },
  duration: {
    marginTop: 'auto',
    paddingTop: 24,
    fontFamily: 'var(--mono)',
...
export default function Process() {
  ...
  return (
    <section id="process" data-screen-label="Process" style={styles.section}>
      <div className="wrap">
        <div className="proc-head reveal in" style={styles.head}>
          <div>
            <div className="mono" style={styles.kicker}>How it works</div>
            <h1 style={styles.title}>
              Four steps,<br />no <span style={{ fontStyle: 'italic', color: 'var(--amber)' }}>guesswork</span>.
            </h1>
          </div>
          <p style={styles.blurb}>
            Twenty years of software development has taught us one thing: clarity beats velocity. Every project follows the same rhythm, a tight loop you can predict, measure, and trust.
          </p>
        </div>

        <div className="proc-rail" style={styles.rail}>
          {steps.map((s, i) => (
            <div
              key={i}
